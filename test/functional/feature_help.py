...
"""Verify that starting aiblockchain with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aiblockchain with -h for help text")
        ...
        self.log.info("Start aiblockchain with -version for version information")
        ...
        self.log.info("Start aiblockchaind with -fakearg to make sure it does not start")
