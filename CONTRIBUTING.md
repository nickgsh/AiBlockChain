Contributing to Aiblockchain Core
============================

The Aiblockchain Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Aiblockchain Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/aiblockchain-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to aiblockchain-qt
...
The following applies to code changes to the Aiblockchain Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Aiblockchain
Network Protocol consensus changes.

Whether a pull request is merged into Aiblockchain Core rests with the project merge
...
Patches that change Aiblockchain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Aiblockchain consensus, it must have been
...
The project leader is the release manager for each Aiblockchain Core release.
