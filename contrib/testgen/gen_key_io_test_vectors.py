...
bech32_templates = [
  ...
  ('aibc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('aibc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('aibc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('aibc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('taibc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('taibc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('taibc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('taibc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('taibc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('taibc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('taibc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('taibc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('raibc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('raibc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('raibc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('raibc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('taibc',   17, 32, Encoding.BECH32M, False, False, False),
  ('raibc',  3,  1, Encoding.BECH32M, False, False, False),
  ('aibc',   15, 41, Encoding.BECH32M, False, False, False),
  ('taibc',    0, 16, Encoding.BECH32,  False, False, False),
  ('raibc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('aibc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('taibc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('raibc',  0, 20, Encoding.BECH32,  False, False, True),
  ('aibc',    0, 20, Encoding.BECH32M, False, False, False),
  ('taibc',    0, 32, Encoding.BECH32M, False, False, False),
  ('raibc',  0, 20, Encoding.BECH32M, False, False, False),
  ('aibc',    1, 32, Encoding.BECH32,  False, False, False),
  ('taibc',    2, 16, Encoding.BECH32,  False, False, False),
  ('raibc', 16, 20, Encoding.BECH32,  False, False, False),
]
