# Support for Output Descriptors in Aiblockchain Core

Since Aiblockchain Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `aibc1...` for mainnet or `taibc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Aiblockchain Core wallets, a convenience function `combo` is
