Aiblockchain Core version 0.17.1 is now available from:
...
The default minimum transaction fee `-mintxfee` has been lowered to 0.0001 AIBC/kB after relaxing the minimum relay and dust relay fee rates in prior releases. 
...
prefixing the option with the network, such as:
    ...
    main.uacomment=aiblockchain
    test.uacomment=aiblockchain-testnet
...
be used in V0.17 by starting aiblockchaind with the '-deprecatedrpc=accounts'
...
BIP 174 Partially Signed Aiblockchain Transactions support
-----------------------------------------------------
...
- New `fees` field introduced in `getrawmempool`, `getmempoolancestors`, `getmempooldescendants` and
   ...
   and `descendant` denominated in AIBC. This new field deprecates previous fee fields, such as
