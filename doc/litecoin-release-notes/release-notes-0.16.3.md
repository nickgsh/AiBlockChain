Aiblockchain Core version 0.16.3 is now available from:

  <https://download.aiblockchain.org/aiblockchain-0.16.3/>
...
Aiblockchain Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
